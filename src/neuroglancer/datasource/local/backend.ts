...
@registerSharedObject() export class LocalVolumeChunkSource extends
...
@registerSharedObject() export class LocalMeshSource extends
(WithParameters(MeshSource, MeshSourceParameters)) {
  download(chunk: ManifestChunk, cancellationToken: CancellationToken) {
    let {parameters} = this;
    let requestPath = `${parameters.path}/${chunk.objectId}_${parameters.lod}`;
    return sendHttpRequest(
